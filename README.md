...
#### The copy Problem
The `copy` method of a data class acts as a constructor, and it's not affected by the visibility of other constructors, this means that it does not obey our validation rules, you can read more about this [here](https://medium.com/swlh/value-based-classes-and-error-handling-in-kotlin-3f14727c0565)
...
### Testing
The `validation-testing` artifact has many useful utility functions for testing validations, you can find them listed [here](TODO)
